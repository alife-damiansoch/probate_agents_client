    ...
    >
      ...
      <div style={styles.contentWrapper}>
        ...
        >
          ...
          <div>
            <div className='fw-bold text-white mb-1'>Email Communications</div>
            <div
              className='small'
              style={{ color: 'rgba(255, 255, 255, 0.7)' }}
            >
              Direct Applicant Email • Document Delivery
            </div>
          </div>
        </div>
          ...
          <div className='d-flex justify-content-between align-items-center mb-4'>
            <div>
              ...
              <p className='text-muted'>
                Manage document emails for this application
              </p>
            </div>
            <button
              style={styles.button}
            ...
            {[
              {
                ...
                value: emails.length,
                icon: Mail,
                color: 'linear-gradient(90deg, #8b5cf6 0%, #a855f7 100%)',
              },
              {
                label: 'Sent',
          ...
          <div style={styles.card}>
            ...
            {emailsLoading ? (
              <div className='p-5 text-center'>
                <Loader2
                  size={32}
                  className='text-primary mb-3 spinner-border'
                />
